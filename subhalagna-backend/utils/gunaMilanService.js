/**
 * @fileoverview SubhaLagna v2.3.0 — Guna Milan Service
...
/**
 * @desc Resolves Rashi if it might be ambiguous due to Pada
 */
...
const calculateGunaMilan = (partner1, partner2) => {
  ...
  else if ((p1Nak.gana === 'Deva' && p2Nak.gana === 'Manushya') || (p1Nak.gana === 'Manushya' && p2Nak.gana === 'Deva')) ganaScore = 5;
  else if ((p1Nak.gana === 'Deva' && p2Nak.gana === 'Rakshasa') || (p1Nak.gana === 'Rakshasa' && p2Nak.gana === 'Deva')) ganaScore = 1;
  ...
  return {
    ...
    breakdown,
    cancellations,
    label: totalScore >= 32 ? 'Excellent' : totalScore >= 24 ? 'Very Good' : totalScore >= 18 ? 'Average' : 'Low'
  };
};
