/**
 * @fileoverview SubhaLagna v2.3.2 — Shortlisted Profiles Page
    ...
    <div className="min-h-screen bg-slate-50/50 pb-20">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
          ...
          <Link to="/matches" className="px-6 py-2.5 bg-white border border-rose-100 text-rose-600 rounded-xl font-bold text-sm shadow-sm hover:bg-rose-50 transition-all flex items-center gap-2">
            Find More Matches 
        ...
        {profiles.length === 0 ? (
          <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-16 border border-rose-100 text-center flex flex-col items-center">
            <div className="w-20 h-20 bg-rose-50 rounded-full flex items-center justify-center text-rose-400 mb-6 text-3xl">🔖</div>
            <h2 className="text-2xl font-serif font-bold text-gray-800 mb-2">Your Shortlist is Empty</h2>
            <p className="text-gray-500 max-w-sm mb-8">Start exploring matches and save the ones that catch your eye!</p>
            <Link to="/matches" className="px-10 py-4 bg-rose-600 text-white rounded-2xl font-bold shadow-lg shadow-rose-200 hover:bg-rose-700 transition-all">
              Go to Matches
            </Link>
          </div>
        ) : (
