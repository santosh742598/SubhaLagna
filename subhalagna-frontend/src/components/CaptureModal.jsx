/**
 * @fileoverview SubhaLagna v2.3.0 — Capture Modal
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-md animate-fade-in">
      <div className="bg-white rounded-[2.5rem] w-full max-w-xl overflow-hidden shadow-2xl border border-white/20 relative group">
        ...
        <div className="px-8 py-6 border-b border-rose-50 flex items-center justify-between">
          ...
          <button onClick={onClose} className="p-2 hover:bg-rose-50 rounded-xl transition-colors text-gray-400 hover:text-rose-500">
        ...
        <div className="relative aspect-video bg-black overflow-hidden flex items-center justify-center">
          {error ? (
            <div className="text-center p-10">
              ...
              <button onClick={startCamera} className="mt-4 text-rose-400 text-sm font-bold hover:underline">Try Again</button>
            </div>
          ) : (
            <>
              <video 
        ...
        <div className="px-8 py-8 flex items-center justify-between bg-gray-50/50">
           ...
           <div className="flex gap-4">
             <button onClick={onClose} className="px-6 py-3 text-sm font-bold text-gray-500 hover:text-gray-700 transition-colors">
               Cancel
             </button>
             <button 
