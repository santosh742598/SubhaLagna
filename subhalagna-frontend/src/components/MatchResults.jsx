/**
 * @file        SubhaLagna v3.3.8 — Match Results
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            ...
            <p className="text-pink-100 max-w-lg">
              Explore profiles tailored to your values and interests. Using our smart compatibility
              algorithm.
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 inline-flex flex-col items-center">
            ...
            <span className="text-[10px] uppercase font-bold tracking-widest text-pink-100">
              Profiles Found
            </span>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-100 rounded-lg px-2 py-1.5 text-sm"
                    />
                ...
                <div className="space-y-1.5">
                  <SearchableDropdown
                    ...
                    options={['Any', ...motherTongueOptions]}
                    onChange={handleFilterChange}
                  />
                </div>
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="bg-white rounded-3xl border border-pink-100/60 p-4 mb-6 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="relative w-full md:w-80">
                <svg
                  className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 font-bold"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {activeFilterCount > 0 && (
              <div className="flex flex-wrap items-center gap-2 mb-6">
                ...
                <FilterTag
                  label="Religion"
                  value={filters.religion}
                  onClear={() => clearFilter('religion')}
                />
                <FilterTag
                  label="Caste"
                  value={filters.caste}
                  onClear={() => clearFilter('caste')}
                />
                <FilterTag
                  label="Language"
                  value={filters.motherTongue}
                  onClear={() => clearFilter('motherTongue')}
                />
                <FilterTag
                  label="Education"
                  value={filters.education}
                  onClear={() => clearFilter('education')}
                />
                <FilterTag
                  label="Manglik"
                  value={
                    filters.manglik === 'true' ? 'Yes' : filters.manglik === 'false' ? 'No' : ''
                  }
                  onClear={() => clearFilter('manglik')}
                />
              </div>
            )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-500">
                      Based on your saved partner preferences from your dashboard.
                    </p>
                  </div>
                </div>
                <button
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 mt-20 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-medium">
            © 2026 SubhaLagna Matrimony. Finding love, one connection at a time.
          </p>
        </div>
      </footer>
