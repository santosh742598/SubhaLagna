/**
 * @fileoverview SubhaLagna v3.0.0 — Privacy Shield Component
...
const PrivacyShield = ({ compact = false }) => {
  return (
    <div className="absolute inset-0 z-20 backdrop-blur-3xl bg-white/10 flex flex-col items-center justify-center p-4 text-center">
      <div
        className={`${compact ? 'p-1.5' : 'p-3'} bg-rose-500/20 rounded-full border border-white/30 mb-2 animate-glow`}
      >
        <svg
